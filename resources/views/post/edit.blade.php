    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-warning">
                ...
                <form role="form"method="post" action="{{ url('post/update', $dt->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-9">
                                ...
                                <!-- form start -->
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="exampleInputEmail1" value="{{ $dt->title }}" placeholder="Masukan Judul Artikel">
                                        </div>
                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ url('artikel', $dt->image) }}" id='img-upload' /> <center><p>Image Preview</p></center><hr>
                                    </div>
                                    <div class="form-group" style="margin-top: -15px">
                                        <label>Category</label>
                                        <select class="form-control select2" style="width: 100%;" name="category_id">
                                            @foreach ($category as $ctg)
                                                <option value="{{ $ctg->id }}" {{($dt->category_id == $ctg->id ? 'selected' : '')}}>{{ $ctg->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div><hr>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success btn-block"><i class="fa fa-save"> Update</i></button>
                                </div>
                            </div>
                        </div>
                    </div>
