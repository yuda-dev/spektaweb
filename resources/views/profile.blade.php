              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       ...
                       alt="User profile picture" style="height: 120px; width: 115px">
                </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    <!-- Post -->
                    <div class="post">
                      <form role="form" enctype="multipart/form-data" method="post" action="{{url('users/ubahprofile')}}">
                        @csrf
                        @method('PUT')
                  ...
                  <div class="tab-pane" id="timeline">
                    <form role="form" method="post" action="{{url('users/ubahpassword')}}">
                      @csrf
                      @method('PUT')
                      <div class="input-group mb-3">
