                        ...
                        <div class="table table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('contact',$dt->id)}}" class="btn btn-sm btn-flat btn-success"><i class="fa fa-eye"></i> </a>
                                        <a href="{{url('contact/delete',$dt->id)}}" class="btn btn-sm btn-flat btn-danger btn-hapus"><i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
