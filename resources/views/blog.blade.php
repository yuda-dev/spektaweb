                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="single_trip">
                                            ...
                                            <div class="info">
                                                <div class="date">
                                                    <span>
                                                        <i class="fa fa-user"> {{ $ar->user->name }} </i> | 
                                                        <a href="{{ url('posts', $ar->id) }}"> <i class="fa fa-eye"> {{ $ar->view_count }}</i></a>  |
                                                        <a href="{{ url('category/post', $ar->category_id) }}"><i class="fa fa-tag"> {{ $ar->categories->nama }}</i></a>
                                                    </span>
                                                </div>
                                                <a href="{{ url('posts', $ar->slug) }}">
                                                    <h5>{{ $ar->title }}</h5>
                                                </a>
                                            </div>
                                        </div>
