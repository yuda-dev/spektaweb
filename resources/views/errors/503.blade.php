...
<html lang="en">
<head>
	<title>Maintenance - SpektaWeb</title>
		...
		<div class="main-area center-text" >
			...
			<div class="display-table">
				<div class="display-table-cell">
					...
					<p class="desc font-white">I will be back on Saturday	:</p>
					
					<div id="normal-countdown" data-date="2020/08/22 10:00:00"></div>
					
					<ul class="social-btn">
						<li class="list-heading">Follow us for update</li>
						<li><a href="https://www.facebook.com/yuda.muhtar/"><i class="ion-social-facebook"></i></a></li>
						<li><a href="https://www.instagram.com/yudamuhtar/"><i class="ion-social-instagram-outline"></i></a></li>
					</ul>
